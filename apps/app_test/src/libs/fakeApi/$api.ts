    ...
    api: {
      v1: {
        Activities: {
          _id: (val3: number) => {
            ...
            return {
              ...
              get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods_1w60l3m['get']['resBody'], BasicHeaders, Methods_1w60l3m['get']['status']>(
                  prefix,
                  prefix3,
                  GET,
                  option,
              ...
              put: (option: { body: Methods_1w60l3m['put']['reqBody']; config?: T | undefined }) =>
                fetch<Methods_1w60l3m['put']['resBody'], BasicHeaders, Methods_1w60l3m['put']['status']>(
                  prefix,
                  prefix3,
                  PUT,
                  option,
              ...
              $delete: (option?: { config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods_1w60l3m['delete']['status']>(prefix, prefix3, DELETE, option)
                  .send()
                  .then((r) => r.body),
              $path: () => `${prefix}${prefix3}`,
            };
           ...
           */
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods_1a2wr86['get']['resBody'], BasicHeaders, Methods_1a2wr86['get']['status']>(
              prefix,
              PATH0,
              GET,
              option,
          ...
          post: (option: { body: Methods_1a2wr86['post']['reqBody']; config?: T | undefined }) =>
            fetch<Methods_1a2wr86['post']['resBody'], BasicHeaders, Methods_1a2wr86['post']['status']>(
              prefix,
              PATH0,
              POST,
              option,
        ...
        Authors: {
          _id: (val3: number) => {
            ...
            return {
               ...
               */
              get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods_jcy81n['get']['resBody'], BasicHeaders, Methods_jcy81n['get']['status']>(
                  prefix,
                  prefix3,
                  GET,
                  option,
              ...
              put: (option: { body: Methods_jcy81n['put']['reqBody']; config?: T | undefined }) =>
                fetch<Methods_jcy81n['put']['resBody'], BasicHeaders, Methods_jcy81n['put']['status']>(
                  prefix,
                  prefix3,
                  PUT,
                  option,
              ...
              $delete: (option?: { config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods_jcy81n['delete']['status']>(prefix, prefix3, DELETE, option)
                  .send()
                  .then((r) => r.body),
              $path: () => `${prefix}${prefix3}`,
            };
            ...
            books: {
              _idBook: (val5: number) => {
                ...
                return {
                   ...
                   */
                  get: (option?: { config?: T | undefined } | undefined) =>
                    fetch<Methods_u66uca['get']['resBody'], BasicHeaders, Methods_u66uca['get']['status']>(
                      prefix,
                      prefix5,
                      GET,
                      option,
           ...
           */
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods_rhkq95['get']['resBody'], BasicHeaders, Methods_rhkq95['get']['status']>(
              prefix,
              PATH1,
              GET,
              option,
          ...
          post: (option: { body: Methods_rhkq95['post']['reqBody']; config?: T | undefined }) =>
            fetch<Methods_rhkq95['post']['resBody'], BasicHeaders, Methods_rhkq95['post']['status']>(
              prefix,
              PATH1,
              POST,
              option,
        ...
        Books: {
          _id: (val3: number) => {
            ...
            return {
               ...
               */
              get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods_25p1dx['get']['resBody'], BasicHeaders, Methods_25p1dx['get']['status']>(
                  prefix,
                  prefix3,
                  GET,
                  option,
              ...
              $put: (option: { body: Methods_25p1dx['put']['reqBody']; config?: T | undefined }) =>
                fetch<void, BasicHeaders, Methods_25p1dx['put']['status']>(prefix, prefix3, PUT, option)
                  .send()
                  .then((r) => r.body),
              delete: (option?: { config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods_25p1dx['delete']['status']>(prefix, prefix3, DELETE, option).send(),
              $delete: (option?: { config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods_25p1dx['delete']['status']>(prefix, prefix3, DELETE, option)
                  .send()
                  .then((r) => r.body),
              $path: () => `${prefix}${prefix3}`,
            };
           ...
           */
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods_uon7jv['get']['resBody'], BasicHeaders, Methods_uon7jv['get']['status']>(
              prefix,
              PATH3,
              GET,
              option,
          ...
          $post: (option: { body: Methods_uon7jv['post']['reqBody']; config?: T | undefined }) =>
            fetch<void, BasicHeaders, Methods_uon7jv['post']['status']>(prefix, PATH3, POST, option)
              .send()
              .then((r) => r.body),
          $path: () => `${prefix}${PATH3}`,
        },
        CoverPhotos: {
          _id: (val3: number) => {
            ...
            return {
               ...
               */
              get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods_6hhl7l['get']['resBody'], BasicHeaders, Methods_6hhl7l['get']['status']>(
                  prefix,
                  prefix3,
                  GET,
                  option,
              ...
              put: (option: { body: Methods_6hhl7l['put']['reqBody']; config?: T | undefined }) =>
                fetch<Methods_6hhl7l['put']['resBody'], BasicHeaders, Methods_6hhl7l['put']['status']>(
                  prefix,
                  prefix3,
                  PUT,
                  option,
              ...
              $delete: (option?: { config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods_6hhl7l['delete']['status']>(prefix, prefix3, DELETE, option)
                  .send()
                  .then((r) => r.body),
              $path: () => `${prefix}${prefix3}`,
            };
            ...
            covers: {
              _idBook: (val5: number) => {
                ...
                return {
                   ...
                   */
                  get: (option?: { config?: T | undefined } | undefined) =>
                    fetch<Methods_oez6qe['get']['resBody'], BasicHeaders, Methods_oez6qe['get']['status']>(
                      prefix,
                      prefix5,
                      GET,
                      option,
           ...
           */
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods_un6193['get']['resBody'], BasicHeaders, Methods_un6193['get']['status']>(
              prefix,
              PATH4,
              GET,
              option,
          ...
          post: (option: { body: Methods_un6193['post']['reqBody']; config?: T | undefined }) =>
            fetch<Methods_un6193['post']['resBody'], BasicHeaders, Methods_un6193['post']['status']>(
              prefix,
              PATH4,
              POST,
              option,
        ...
        Users: {
          _id: (val3: number) => {
            ...
            return {
              ...
              $get: (option?: { config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods_ih8f27['get']['status']>(prefix, prefix3, GET, option)
                  .send()
                  .then((r) => r.body),
              ...
              $put: (option: { body: Methods_ih8f27['put']['reqBody']; config?: T | undefined }) =>
                fetch<void, BasicHeaders, Methods_ih8f27['put']['status']>(prefix, prefix3, PUT, option)
                  .send()
                  .then((r) => r.body),
              delete: (option?: { config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods_ih8f27['delete']['status']>(prefix, prefix3, DELETE, option).send(),
              $delete: (option?: { config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods_ih8f27['delete']['status']>(prefix, prefix3, DELETE, option)
                  .send()
                  .then((r) => r.body),
              $path: () => `${prefix}${prefix3}`,
            };
           ...
           */
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods_2432u5['get']['resBody'], BasicHeaders, Methods_2432u5['get']['status']>(
              prefix,
              PATH6,
              GET,
              option,
          ...
          $post: (option: { body: Methods_2432u5['post']['reqBody']; config?: T | undefined }) =>
            fetch<void, BasicHeaders, Methods_2432u5['post']['status']>(prefix, PATH6, POST, option)
              .send()
              .then((r) => r.body),
          $path: () => `${prefix}${PATH6}`,
        },

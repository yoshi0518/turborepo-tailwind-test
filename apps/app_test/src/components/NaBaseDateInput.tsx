...
import classes from './NaBaseDateInput.module.scss';
 ...
 */
export type NaBaseDateInputProps = Omit<ComponentPropsWithRef<'button'>, 'size' | 'value'> &
  Omit<DatePickerInputProps, 'variant' | 'size'> & {
...
/** NaBaseDateInput(共通UI) */
export const NaBaseDateInput: FC<NaBaseDateInputProps> = forwardRef(
  (
    {
      variant = 'default',
      size = 'default',

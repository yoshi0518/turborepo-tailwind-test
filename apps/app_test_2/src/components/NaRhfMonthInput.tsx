...
import classes from './NaRhfMonthInput.module.scss';
 ...
 */
export type NaRhfMonthInputProps = Omit<ComponentPropsWithRef<'button'>, 'size' | 'value' | 'onChange'> &
  Omit<MonthPickerInputProps, 'variant' | 'size' | 'onChange'> & {
...
/** NaRhfMonthInput(共通UI) */
export const NaRhfMonthInput: FC<NaRhfMonthInputProps> = forwardRef(
  (
    {
      variant = 'default',
      size = 'default',

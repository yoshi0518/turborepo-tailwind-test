...
import classes from './NaBaseMonthInput.module.scss';
 ...
 */
export type NaBaseMonthInputProps = Omit<ComponentPropsWithRef<'button'>, 'size' | 'value'> &
  Omit<MonthPickerInputProps, 'variant' | 'size'> & {
...
/** NaBaseMonthInput(共通UI) */
export const NaBaseMonthInput: FC<NaBaseMonthInputProps> = forwardRef(
  (
    {
      variant = 'default',
      size = 'default',

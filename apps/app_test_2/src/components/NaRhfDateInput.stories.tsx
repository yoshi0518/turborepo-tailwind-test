...
import { NaRhfDateInput } from './NaRhfDateInput';

import type { NaRhfDateInputProps } from './NaRhfDateInput';

export default {
  title: 'Date/NaRhfDateInput',
  component: NaRhfDateInput,
  render: ({ ...otherProps }) => <NaRhfDateInput {...otherProps} />,
  argTypes: {
    variant: {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof NaRhfDateInput>;

type Story = StoryObj<typeof NaRhfDateInput>;

const defaultProps: NaRhfDateInputProps = {
  variant: 'default',
  size: 'default',
  round: false,
  withAsterisk: false,

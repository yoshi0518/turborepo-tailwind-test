...
import { NaRhfMonthInput } from './NaRhfMonthInput';

import type { NaRhfMonthInputProps } from './NaRhfMonthInput';

export default {
  title: 'Date/NaRhfMonthInput',
  component: NaRhfMonthInput,
  render: ({ ...otherProps }) => <NaRhfMonthInput {...otherProps} />,
  argTypes: {
    variant: {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof NaRhfMonthInput>;

type Story = StoryObj<typeof NaRhfMonthInput>;

const defaultProps: NaRhfMonthInputProps = {
  variant: 'default',
  size: 'default',
  round: false,
  withAsterisk: false,

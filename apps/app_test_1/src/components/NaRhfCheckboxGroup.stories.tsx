...
import { NaRhfCheckboxGroup } from './NaRhfCheckboxGroup';

import type { NaRhfCheckboxGroupProps, NaRhfCheckboxItemProps } from './NaRhfCheckboxGroup';

export default {
  title: 'Input/NaRhfCheckboxGroup',
  component: NaRhfCheckboxGroup,
  render: ({ ...otherProps }) => <NaRhfCheckboxGroup {...otherProps} />,
  argTypes: {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof NaRhfCheckboxGroup>;

type Story = StoryObj<typeof NaRhfCheckboxGroup>;

const defaultCheckboxItems: NaRhfCheckboxItemProps[] = [
...
const defaultProps: NaRhfCheckboxGroupProps = {
